                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/bookReview', {
                                ...
                                bookId: $this.find('.Hidden-bookId').val(),
            ...
            return {
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/requestPhoneConfirmation', data, function (result) {
                            if (result.result) {
                        ...
                        Login().postData('/payment', {
                            ...
                            if (result.url != null) {
                                ...
                                $('.Topup-wrap').append('<div class="form-group">'
                                    + '<div class="Topup-error" style="color:red; text-align: center">' + result.error + '</div>' + '</div>');
                                $('form.Topup').trigger('reset');
                            }
                        })
                    });
                }
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            if (result.responseJSON.count == 0) {
                                $('.Transactions-footer_center').css("display", "none");
                                return;
                            }
